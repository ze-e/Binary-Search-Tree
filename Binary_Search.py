...
"--breadth","-b" : takes an integer as an argument, and performs a breadthFirstSearch on the tree for this integer
        
"--depth","-d" :  takes an integer as an argument, and performs a depthFirstSearch on the tree (by default inorder) for this integer
"--inorder","-in" : for use with depthFirstSearch. Changes the type of dfs to inorder
"--preorder","-pre" : for use with depthFirstSearch. Changes the type of dfs to preorder
"--postorder","-post" : for use with depthFirstSearch. Changes the type of dfs to postorder
...
def main():
    ...
    parser.add_argument("--breadth","-b",help="takes an integer as an argument, and performs a breadthFirstSearch on the tree for this integer")
    parser.add_argument("--depth","-d", help="takes an integer as an argument, and performs a depthFirstSearch on the tree for this integer")
    parser.add_argument("--inorder","-in",help="takes an integer as an argument, and performs a depthFirstSearch (inorder) on the tree for this integer",action="store_true")
    parser.add_argument("--preorder","-pre",help="takes an integer as an argument, and performs a depthFirstSearch (preorder) on the tree for this integer",action="store_true")
    parser.add_argument("--postorder","-post",help="takes an integer as an argument, and performs a depthFirstSearch (postorder) on the tree for this integer",action="store_true")   
